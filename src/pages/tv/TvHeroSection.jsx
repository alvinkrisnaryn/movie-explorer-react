      ...
      <AnimatePresence>
        ...
        >
          ...
          <div className="relative z-10 max-w-full md:max-w-3xl px-4 md:px-6 top-1/4 md:top-1/3 text-left md:text-left">
            ...
            <p className="text-sm md:text-lg font-bold mb-3 md:mb-4 flex md:gap-2 items-start justify-start md:justify-start">
            ...
            <div className="relative mb-3 md:mb-4">
              <p
                className={`text-base md:text-base text-gray-200 font-medium ${
